...
import animationData from "./components/lotttie/loading.json";

const Home = lazy(() => import("./components/Home"));
const Footer = lazy(() => import("./components/Footer"));
const AddInfo = lazy(() => import("./components/AddInfo"));
        ...
        <ul>
          ...
          <li>
            <Link to="/Add">
              ...
              <span class="nav-res">Add Info</span>
            </Link>
          </li>
          ...
          <li>
            <Link to="/Students">
              ...
              <span class="nav-res">Students</span>
            </Link>
          </li>
      ...
      <Suspense
        fallback={
          <>
            ...
            >
              <Lottie
                style={{ height: "30vw", marginTop: "40px" }}
